...
cerberus = ORE(model, scorer,idx, graph, laff_graph, budget=args.budget, verbose=True)
...
result = pt.Experiment(
        [   
            ...
            bm25_cerberus >> ORE(model, scorer, idx, graph,laff_graph, budget=args.budget, 
